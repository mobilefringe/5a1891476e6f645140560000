            ...
            <div class="feature-div" style="height:580px">
                <span>
                    <div class="feature-box" v-for="item in feature_items">
                        ...
                        <span class="feature_read_more"><router-link :to="item.url" class="mobile_readmore" ><p class="feature-readmore">Read More</p><i class="fa fa-chevron-right pull-right" aria-hidden="true"></i></router-link></span>
                    </div>
                </span>
            </div>
        </div>
