...
<script>
    define(["Vue", "vue!today_hours", "vue!search-component", 'vue!vue-agile'], function(Vue, TodayHoursComponent, SearchComponent, agile) {
        return Vue.component("home-component", {
            ...
            computed: {
                ...
                banners () {
                    console.log(_.orderBy(this.$store.state.results.banners, ['position'], ['desc']));
                    return _.orderBy(this.$store.state.results.banners, ['start_date'], ['desc']);
                }
            },
            methods: {
